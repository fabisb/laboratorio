            ...
            <table class="table table-success">
              ...
              <tbody style="font-size: medium;">
                <tr>
                  ...
                  <input type="text" class="form-control" id="inputCaracteristicaItem" value='${nombre}'>
                </div></td>
                ...
                <tr>
                  ...
                  <td colspan='2'><input type="checkbox" class="form-check-input" value="true" formCaracteristica${nombre}" name="imp" ></td>
